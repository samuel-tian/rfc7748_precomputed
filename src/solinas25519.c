...
FIAT_P25519_FIAT_INLINE void fiat_p25519_addcarryx_u64(uint64_t* out1, fiat_p25519_uint1* out2, fiat_p25519_uint1 arg1, uint64_t arg2, uint64_t arg3) {
...
FIAT_P25519_FIAT_INLINE void fiat_p25519_mulx_u64(uint64_t* out1, uint64_t* out2, uint64_t arg1, uint64_t arg2) {
  fiat_p25519_uint128 x1;
  uint64_t x2;
  uint64_t x3;
...
FIAT_P25519_FIAT_INLINE void fiat_p25519_mul(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
